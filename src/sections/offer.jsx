    ...
    >
      ...
      <div className={styles.offerContainer}>
        <div className={styles.offerSelectProps}>
          ...
          <li
            className={activeSection === "dealerHub" ? styles.active : ""}
            onClick={() => handleSectionClick("dealerHub")}
          >
            Dealer Hub
          </li>
          <li
        ...
        <div className={styles.OfferOfferContentContainer}>
          ...
          <div
            className={`${styles.section} ${activeSection === "dealerHub" && !isTransitioning ? styles.active : ""} ${isTransitioning ? styles.fadeOut : styles.fadeIn}`}
          >
            {activeSection === "dealerHub" && (
              <div
                className={`${styles.webDesignContainer} ${styles.dealerHub}`}
              >
                <motion.div
                  className={styles.webDesignContent}
                  initial="hidden"
                ...
                >
                  ...
                  <h1 className={styles.webDesignh1}>
                    A Dealer Hub is a comprehensive platform for engaging
                  ...
                  <div className={styles.WebDesignFeatures}>
                    <div className={styles.WebDesignFeaturesContent}>
                      ...
                      <p>
                        An interactive environment where customers can explore
                        inventory, ask questions, and engage with posts—such as
                        commenting on new stock.
                      </p>
                    </div>
                    <div className={styles.WebDesignFeaturesContent}>
                      <div className={styles.webFeaturesImgShadow}>
