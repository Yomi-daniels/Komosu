...
import DealershipBentoGrid from "@/app/dealership_hub/DealershipBentoGrid";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 items-center justify-center max-w-[736px] mx-auto max-md:px-[2rem] max-sm:px-[1rem] max-sm:max-w-[686px]">
        ...
        Dealership <span className="font-custom text-btn">Websites</span>{" "}
       Aren’t Built for Paid Traffic
