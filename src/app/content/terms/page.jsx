  ...
  return (
    ...
    <div>
      ...
      <div className="mt-[24px] text-[18px] relative">
        ...
        <p> Both parties agree to maintain the confidentiality of any proprietary or sensitive information exchanged during the project, including strategies, data, and materials.</p>
        </div>
        <div className="mt-[24px] text-[18px] relative">
