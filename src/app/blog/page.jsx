            ...
            <div className="w-full md:w-[528px] h-[300px] relative ">
             ...
             <div className="mx-auto w-3/4 space-y-12 mt-[3rem] max-sm:w-full max-sm:px-4">
               ...
               <div className="flex flex-col gap-4">
                ...
                <div className="w-96 min-h-96 relative border-x max-sm:border-y  border-indigo-100  px-4  py-[24px]">
                 ...
                 />
                    ...
                    <div className="flex flex-col gap-4">
                     ...
                     <div className="mx-auto w-3/4 space-y-12 mt-[3rem] max-sm:w-full max-sm:px-4">
                       <h2 className="text-darkBlueText text-2xl font-medium capitalize">All Posts</h2>
                ...
                return (
                  <div key={post.slug} className="bg-white p-4 rounded-xl shadow-md flex flex-col md:flex-row gap-6">
                    <div className="w-full md:w-2/5 relative h-40">
                      <Image src={post.image || "/placeholder.png"} alt={post.title} fill className="object-cover rounded-lg" />
                    </div>
                    <div className="flex-1 flex flex-col gap-2">
                      <h3 className="text-2xl font-semibold text-darkBlueText">{post.title}</h3>
