  ...
  return (
    ...
    {/* COMMENT THE DIV BELOW WHEN YOU WANT TO EDIT BLOG PAGE!!! */}
      ...
      <div className="flex flex-col justify-center fixed top-0 left-0 w-[100vw] h-[100vh] z-30 bg-black opacity-90 ">
        ...
        <div className="relative opacity-100 flex flex-col items-center justify-center "><Image src="/logo.png" width={200} height={200} alt="logo" objectFit="fill"/>
         <div className="lg:flex items-center gap-2 ">
         <h1 className="text-xs sm:text-sm max-lg:text-xl text-white">Coming Soon</h1>
