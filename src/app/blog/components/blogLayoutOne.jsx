...
const BlogLayoutOne = ({ blog }) => {
  return (
    <div className="group inline-block overflow-hidden  rounded-xl">
      ...
      <div className="w-full p-4 absolute bottom-0 bg-green-50 xs:p-6 sm:p-10 z-20">
        <Tag
        ...
        <Link href={`blog/${blog._raw.flattenedPath}`} className="mt-6">
          <h2 className="font-bold capitalize text-sm xs:text-base sm:text-xl md:text-2xl mt-2 sm:mt-4">
            <span
